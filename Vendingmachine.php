...
<body>
    ...
    <div id="domesticTea">
        <table>
            <tr>
                <td rowspan="3"><?php echo $tea_rating_3_kor_name ?><br/>(<?php echo $tea_rating_3_eng_name ?>)</td><td><?php echo $domestic_tea_1_kor_name ?><br/>(Adlay Tea)</td><td><?php echo $domestic_tea_2_kor_name ?><br/>(Milk)</td><td><?php echo $domestic_tea_3_kor_name ?><br/>(Cocoa)</td><td><?php echo $domestic_tea_4_kor_name ?><br/>(Milk Choco)</td>
            </tr>
            <tr>
