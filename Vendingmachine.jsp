...
<body>
    ...
    <div id="domesticTea">
        <table>
            <tr>
                <td rowspan="3"><%= tea_rating_3_kor_name %><br/>(<%= tea_rating_3_eng_name %>)</td><td><%= domestic_tea_1_kor_name %><br/>(<%= domestic_tea_1_eng_name %>)</td><td><%= domestic_tea_2_kor_name %><br/>(<%= domestic_tea_2_eng_name %>)</td><td><%= domestic_tea_3_kor_name %><br/>(<%= domestic_tea_3_eng_name %>)</td><td><%= domestic_tea_4_kor_name %><br/>(<%= domestic_tea_4_eng_name %>)</td>
            </tr>
            <tr>
