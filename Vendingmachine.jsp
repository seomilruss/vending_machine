...
<body>
	<%!
	    ...
	    String fine_coffe_1_kor_name = "블랙2";
	    String fine_coffe_1_eng_name = "Black2";
	    String fine_coffe_2_kor_name = "설탕2";
	    String fine_coffe_2_eng_name = "Sugar2";
	    String fine_coffe_3_kor_name = "크림2";
	    String fine_coffe_3_eng_name = "Cream2";
	    String fine_coffe_4_kor_name = "설탕크림2";
	    String fine_coffe_4_eng_name = "Sugar Cream2";
